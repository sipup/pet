...
abstract class $CatalogStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ProductEntity> product, bool isLoading});
}
...
class _$CatalogStateImpl implements _CatalogState {
  const _$CatalogStateImpl(
      {required final List<ProductEntity> product, required this.isLoading})
      : _product = product;
  ...
  @override
  String toString() {
    return 'CatalogState(product: $product, isLoading: $isLoading)';
  }
...
abstract class _CatalogState implements CatalogState {
  const factory _CatalogState(
      {required final List<ProductEntity> product,
      required final bool isLoading}) = _$CatalogStateImpl;
